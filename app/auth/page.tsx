...
export default function AuthPage() {
  ...
  const completeSignIn = (nextUser: AuthUser) => {
    login(nextUser);
  ...
  if (loading) {
    return (
      <ProtectedPageSkeleton
        ...
        detail="Verifying whether you already have an active account session."
      />
    );
  }
  ...
  const handleOAuth = async (
    ...
    setBusy(true);
    try {
      const response = await apiRequest<{ user: AuthUser }>("/api/auth/oauth", {
        method: "POST",
        body: JSON.stringify({
          provider,
  ...
  return (
    <main className="feature-page">
      <section className="section-header">
        ...
        <p>
          Secure sign in, modern registration, and unified account state across
          all pages.
        </p>
      </section>
      ...
      <section className="auth-layout">
        ...
        <article className="section-block auth-panel">
          ...
          <p className="meta-line">
            Use your preferred provider and continue instantly.
          </p>
